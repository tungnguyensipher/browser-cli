import { createStandaloneConfigIO, loadStandaloneConfig } from "./runtime-config-store.js";
...
export function refreshResolvedBrowserConfigFromDisk(params: {
  ...
  const cfg = params.mode === "fresh" ? createStandaloneConfigIO().loadConfig() : loadStandaloneConfig();
